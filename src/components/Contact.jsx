...
export default function Contact() {
  return (
    <section id="contact" className="section-padding" style={{ background: 'var(--bg-secondary)', paddingTop: '5rem' }}>
      <style>{`
        .contact-badge-item {
      ...
      <div className="container">
        ...
        <div className="grid-2" style={{ gap: '3rem', alignItems: 'stretch' }}>
          ...
          <div className="glass-panel" style={{
            ...
            <div>
              <h3 style={{ fontSize: '1.75rem', marginBottom: '1rem', color: 'var(--text-primary)', fontWeight: 700 }}>
                Get in Touch
              </h3>
              <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, marginBottom: '2.5rem' }}>
                Reach out to our team directly through any of our support channels below. We typically respond within one business day.
              </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
                ...
                <div className="contact-badge-item" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Phone</div>
                ...
                <div className="contact-badge-item" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Email</div>
                    <a
                ...
                <div className="contact-badge-item" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>WhatsApp</div>
                ...
                <div className="contact-badge-item" style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Direct SMS</div>
